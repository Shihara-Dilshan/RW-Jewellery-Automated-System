...
class GetRecoverCode extends Component {
  ...
  passwordRecover = async (e) => {
    ...
    if (
      RecoverCodeCheck === "" ||
      RecoverCodeCheck === null ||
      RecoverCodeCheck === undefined
    ) {
  ...
  static sendEmail = async (email, code, userName) => {
    ...
    var data = {
      from:
        "Mailgun Sandbox <postmaster@sandbox4eab8755f9304dcd8a83626af0597370.mailgun.org>",
      to: email,
          ...
          <div className="card horizontal">
            ...
            <div className="card-stacked">
              <div className="card-content">
                ...
                <p className="center-align teal-text">
                  ...
                  <form className="col s12">
                    <div className="row">
                      <div className="input-field col s12">
                        <input id="inputRecoverCode" type="text" />
                        <label htmlFor="inputRecoverCode" id="inputRLabel">
                          6 digit-code
                        </label>
                      </div>
                    </div>
