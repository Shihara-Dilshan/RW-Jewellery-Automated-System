...
class NewDesign extends Component {
  ...
  async componentDidMount(){
    	...
    	this.setState({userPurchuses: tempResult.filter( data => data.isEditable === "yes" &&  data.status === "new" )});
        ...
        <tbody>
         {this.state.userPurchuses.map((design) => {
        	return(
              ...
              <td><button id={design.service_id} className="btn" onClick={this.assign}>Assign</button></td>
           </tr>
        	);
        })}
