...
class CompletedOrders extends Component {
  ...
  async componentDidMount(){
    	...
    	this.setState({userPurchuses: tempResult.filter( data => data.isEditable === "no" &&  data.status === "completed" )});
          ...
          <div className="card horizontal">
            <div className="card-image hide-on-small-only">
              <img
                id="signUpImage"
                alt=""
                src="https://image.freepik.com/free-vector/completed-concept-illustration_114360-2945.jpg"
                height="100%"
              />
            </div>
            <div className="card-stacked">
              <div className="card-content">
                <h5 className="center-align grey-text">Completed Designs</h5>
                <div className="row">
