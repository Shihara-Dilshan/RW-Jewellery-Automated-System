...
const initialState = {
  ...
  export default class ValidateJewellery extends React.Component {
    ...
    validate = () => {
      ...
      if (materialError || categoryError || desError || supPriceError || discountError || sell_rent_Error) {
        this.setState({materialError , categoryError , desError , supPriceError , discountError , sell_rent_Error});
        return false;
      }
                        ...
                        <h5 align = "center" className = "text-center">Add Jewellery</h5>
                            ...
                            <form onSubmit={this.handleSubmit}>
                              ...
                              {/* Description */}
                                 <div className="row">
                                <div className="input-field col s12">
                                  <input name = "des" id="des" type="text" value={this.state.des} onChange={this.handleDescriptionChange.bind(this)}/>
                                  <label htmlFor="des" id="deslbl">
                                    Description
                                  </label>
                                </div>
                                <div style={{ fontSize: 12, color: "red" }}>
