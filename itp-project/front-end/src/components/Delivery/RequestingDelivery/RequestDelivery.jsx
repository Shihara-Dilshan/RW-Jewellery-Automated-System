  ...
  render() {
    ...
    <div className='constainer' style={this.style()}>
      <div className="row">
        ...
        <img alt="" src="https://png.pngtree.com/png-vector/20190723/ourlarge/pngtree-flat-on-time-delivery-icon--vector-png-image_1569069.jpg"
        height="100%"/>
      </div>
          </div>
      ...
      <div className="row">
                      ...
                      <div className="input-field col s6">
                        <input
                          ...
                          className="validate"
                        />
                        <label htmlFor="Location">Enter Location to deliver</label>
                      </div>
                      <div className="input-field col s6">
                        <input
                          id="Distance"
                          ...
                          className="validate"
                        />
                        <label htmlFor="Distance">How far is it from Mawanella to the given location</label>
                      </div>
                      <div className="input-field col s6">
                        <input
                          id="PhoneNumber"
